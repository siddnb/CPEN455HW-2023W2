...
def image_discretized_mix_logistic_loss(x, l):
...
def to_one_hot(tensor, n, fill_with=1.):
    ...
    if tensor.is_mps : one_hot = one_hot.to(tensor.device)
...
def sample_from_discretized_mix_logistic(l, nr_mix):
    ...
    if l.is_mps : temp = temp.to(l.device)
